...
const char* AIO_USER      = "tuUserDeAdafruitIO";
...
const char* NOMBRES[NUM_LEDS] = {
  ...
  "Santiago",        // LED 3
  "Valparaiso",      // LED 4
  "Isla de Pascua",  // LED 5
  "Juan Fernandez",  // LED 6
  "Punta Arenas",    // LED 7
  "Antartica"        // LED 8
};
...
// Leer de qué feed vino el mensaje — por ejemplo "nicolasvgreve/feeds/humedad-santiago"
  ...
  if (idx == -1) return;   // topic desconocido, ignorar


  humedades[idx]    = payload.toInt();   // Guardar el porcentaje de humedad en el lugar que le corresponde en el array.
  feedRecibido[idx] = true;   // toInt() convierte el texto "72" al número entero 72.
