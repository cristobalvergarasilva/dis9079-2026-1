...
Arreglamos errores de ortografía en el README de la solemne, lo demás todo bien!!

### Ejercicio en clase

- Capacitancia: capacidad de un material para almacenar carga eléctrica
- Sensor capacitivo: detecta cambios en el campo eléctrico producidos por proximidad o contacto
- Capacitor o condensador: componente electrónico que almacena energía eléctrica entre dos superficies conductoras

El cuerpo humano puede alterar campos eléctricos, por eso puede funcionar como parte de un sensor capacitivo 

Con el arduino utilizaremos una protoboard y cables dupont, además de la biblioteca Capacitive_Touch

Tiene pines digitales y analógicos:

- digitales: D0, D1, D2, etc
- analógicas: A0, A1...

en este caso el cable iria en A0 y lo dejamos así y funciona con la otra punta del cable
